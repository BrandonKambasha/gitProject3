...
const serviceCategories = [
  {
    ...
    services: [
          ...
          { icon: ClipboardDocumentCheckIcon, name: "Undertaking Location Risk Assessments", description: "Comprehensive assessments to identify and mitigate risks in various locations" },
